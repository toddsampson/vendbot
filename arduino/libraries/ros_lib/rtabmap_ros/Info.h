...
namespace rtabmap_ros
{
  ...
  class Info : public ros::Msg
  {
    public:
      ...
      float * statsValues;
      uint8_t localPath_length;
      int32_t st_localPath;
      int32_t * localPath;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = localPath_length;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      for( uint8_t i = 0; i < localPath_length; i++){
      union {
        int32_t real;
        uint32_t base;
      } u_localPathi;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint8_t localPath_lengthT = *(inbuffer + offset++);
    ...
    const char * getMD5(){ return "8bcbc6ef1887f1743539b800d7fbba0d"; };
